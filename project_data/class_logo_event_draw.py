...
class TextSprite(Sprite):
    """텍스트 스프라이트 클래스"""
    def __init__(self, x, y, text, font_size=30, color=(255, 0, 0, 0), font_path='/root/hong_openCV/data/NanumPenScript-Regular.ttf'):
        super().__init__(x, y)
        self.text = text
...
class LogoSprite(Sprite):
    """로고 스프라이트 클래스"""
    def __init__(self, x, y, logo_path="/root/hong_openCV/data/cow.png", size=(100, 100)):
        super().__init__(x, y)
